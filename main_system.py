...
If the prompt asks for a name, try to match the appropriate name (of author or artwork).
...
messages = [
    ...
    HumanMessage(content="Give me all artworks whose name contains 'aleksa'")
]
